...
GO
--
-- USER aggregated subservice entries, focusing on customer feedback (ssnr 101-105)
--
IF (OBJECT_ID('SUBSERVICE_USER_RATING') IS NOT NULL) DROP VIEW SUBSERVICE_USER_RATING
GO
CREATE VIEW SUBSERVICE_USER_RATING AS
SELECT
	OFFICEGUID,
	OFFICE_NR,
	USER_NR,
