...
GO
--
-- CASHIER aggregated subservice entries, focusing on customer feedback (ssnr 101-105)
--
IF (OBJECT_ID('SUBSERVICE_CASHIER_RATING') IS NOT NULL) DROP VIEW SUBSERVICE_CASHIER_RATING
GO
CREATE VIEW SUBSERVICE_CASHIER_RATING AS
SELECT
	OFFICEGUID,
	OFFICE_NR,
	CASHIER_NR,
